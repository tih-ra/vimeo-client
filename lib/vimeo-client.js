...
exports.middleware = function(_options) {
	...
	consumer = new oauth.OAuth("http://vimeo.com/oauth/request_token", "http://vimeo.com/oauth/access_token", options.consumerKey, options.consumerSecret, "1.0", "" + options.baseURL + "/vimeo/callback", "HMAC-SHA1");
